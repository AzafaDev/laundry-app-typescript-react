...
export function BottomNav() {
  ...
  return (
    <nav className="bottom-nav">
      <Link to="/pickup" className="bottom-nav-item" title="Pesan Laundry">
        <Shirt className="w-6 h-6" />
        <span className="bottom-nav-label">Pesan</span>
      </Link>

      <Link to="/orders" className="bottom-nav-item" title="Pesanan">
        <ShoppingBag className="w-6 h-6" />
        <span className="bottom-nav-label">Pesanan</span>
      </Link>

      <Link to="/notifications" className="bottom-nav-item" title="Notifikasi">
      ...
      <Link to="/profile" className="bottom-nav-item" title="Profil">
